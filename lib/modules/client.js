...
exports.client = {
	...
	getToken:function (code,callb){
		...
		func.post(callb,this.path,this.data,this.headers)
	},
	...
	revokeToken:function (token, callb){
		...
		func.post(callback,this.path,this.data,this.headers)
	},
	get:function (path, callb) {
		this.path = path
		this.headers = func.getHeaders(this.aToken, 'get')
		func.get(callb,this.path,this.headers)
	},
	...
	put:function (path, data, callb){
		...
		this.headers = func.getHeaders(this.aToken,'post')
		this.data = JSON.stringify(data)
		func.put(callb,this.path,this.data,this.headers)
	},
	patch:function (path, data, callb){
		this.path = path
		this.headers = func.getHeaders(this.aToken,'post')
		this.data = JSON.stringify(data)
		func.patch(callb,this.path,this.data,this.headers)
	},
	delte:function (path,callb){
		this.path = path
		this.headers = func.getHeaders(this.aToken, 'get')
		func.delte(callb,this.path,this.headers)
	},
	upload:function (path, file, callb){
		this.path = path
		this.headers = func.getHeaders(this.aToken, 'get')
		func.upload(callb,path,file,headers)
